...
2.  git remote add boilermaker https://github.com/garyaloisio/GaryBoilerplate.git
...
```
git remote add boilermaker https://github.com/garyaloisio/GaryBoilerplate.git
